...
const reloadBtn = document.getElementsByTagName('button')[0];
reloadBtn.addEventListener('click', () => {
    let randomNumber = Math.floor(Math.random() * quotes.length);
    document.getElementsByTagName('h1')[0].innerHTML = quotes[randomNumber].quoteText;
    document.getElementsByTagName('div')[0].innerHTML = quotes[randomNumber].quoteAuthor;
